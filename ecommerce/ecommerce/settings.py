...
# Be sure to read the guide in the resources folder (SETUP THE EMAIL BACKEND)

EMAIL_HOST_USER = 'rapidofood123@gmail.com' # - Enter your GMAIL address # The host email that sends password reset emails
EMAIL_HOST_PASSWORD = 'syro qprg dsei flnr' # - Enter your app password 
